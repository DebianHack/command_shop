...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<a href="Options/BOOKS/add_books.php?" type="button">Добавить</a>
                                            ...
                                            <?php 
                                              ...
                                              while ($row = mysqli_fetch_assoc($result)) {
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><?php echo $row['categories_books_content_id'] ?></td>
                                                    ...
                                                    <td>
                                                       <div class="btn-group" role="group" aria-label="Basic example">
                                                          <a href = "Options/BOOKS/edit_books.php?id=<?php echo $row['id'] ?>" type="button" >Редактировать</a>
                                                          <a href = "Options/BOOKS/delete_books.php?id=<?php echo $row['id'] ?>"type="button" >Удалить</a>
