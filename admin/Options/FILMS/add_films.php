...
empty($_POST["director"]) && empty($_POST["actors"]) && empty($_POST["categories_films_id"]))
	...
	{
	$sql = "INSERT INTO films (name, description, year, country,director, actors, categories_films_id) 
	VALUES('".$_POST["name"]."', '".$_POST["description"] ."' , '".$_POST["year"]."', '".$_POST["country"]."',
'".$_POST["director"]."','".$_POST["actors"]."', '".$_POST["categories_films_id"]."' )";
var_dump($sql);
...
<html>
 ...
 <h1 class="text-center">Добавление фильма</h1>
