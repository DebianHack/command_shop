...
empty($_POST["country"]) && empty($_POST["categories_books_content_id"]) )
	...
	{
		$sql = "UPDATE  books SET name = '".$_POST["name"]."', year = '".$_POST["year"] ."', author = '".$_POST["author"]."', description ='".$_POST["description"]."' ,country ='".$_POST["country"]."' , 
		categories_books_content_id = '".$_POST["categories_books_content_id"]."' WHERE id = '".$_GET["id"]."'" ; 
