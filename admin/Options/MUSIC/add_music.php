...
if( empty($_POST["name_album"]) && empty($_POST["authors_album"]) && empty($_POST["complement_album"]) && empty($_POST["year"]) && empty($_POST["country"]) && empty($_POST["categories_music_id"]) )
	...
	{
	$sql = "INSERT INTO music (name_album, authors_album, complement_album, year,country, categories_music_id) 
	VALUES('".$_POST["name_album"]."', '".$_POST["authors_album"] ."' , '".$_POST["complement_album"]."', '".$_POST["year"]."',
'".$_POST["country"]."','".$_POST["categories_music_id"]."')";
var_dump($sql);
...
<html>
 ...
 <h1 class="text-center">Добавление музыки</h1>
